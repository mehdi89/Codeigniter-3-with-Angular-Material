(function () {
    ...
    angular
            ...
            .controller('RequisitionController', [
                'uiGridConstants', '$http', '$scope', '$mdEditDialog', '$q', '$timeout', RequisitionController
            ]);
     ...
     * @constructor
     */
    function RequisitionController(uiGridConstants, $http, $scope, $mdEditDialog, $q, $timeout) {
        var self = this;
...
//                unit: ''
        ...
        $http.get(base_url + 'assets/data/desserts.json').then(function (desserts) {
